...
1. **Clone the repository**
   ```bash
   git clone https://github.com/22BCS13002/Sweet-Shop-Management.git
...
**Sarthak Chauhan**
- GitHub: https://github.com/22BCS13002
- Project: https://github.com/22BCS13002/Sweet-Shop-Management/



*Built Sarthak Chauhan  with ❤️ using the MERN stack and modern development practices*
=======
